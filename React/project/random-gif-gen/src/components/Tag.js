...
function Tag(){
  ...
  const [tag, setTag] = useState('salmon bhoi');
  const {gif, loading, fetchData} = useGif(tag);            //here i write three variable (gif , loading , fetchdata) because usegif is returing these three variable;     
